...
<div class="modal-body">
    <form action="<?php echo route('home.user.do_register')  ?>" class="form-horizontal modal-form" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                <input type="password" name="passwd" placeholder="password" class="input-s-sm form-control" minlength="6" maxlength="24" required="" value="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" name="imgcode" placeholder="code" class="input-s-sm form-control" minlength="4" maxlength="4" required="" value="">
            </div>
            <div class="col-lg-3">
