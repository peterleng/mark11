 ...
 * @method mixed all(string $field = '*',string $order = '`id` DESC')
 * @method mixed getList(string|array $where,string $order = '`id` DESC',int $limit = null,string $field = '*')
 * @method int insert(array $values)
 * @method int update(string|array $where,array $values,int $limit = null)
 * @method int delete(string|array $where,int $limit = null)
